...
let empName=empArray.map((value)=>{
        return value.emp_name
})
console.log(empName);
console.log("========================All Employees Department==============================");
let empDept=empArray.map((value)=>{
    return value.emp_depth
})
console.log(empDept);
console.log("========================All Employees Id==============================");
let empId=empArray.map((value)=>{
    return value.emp_id
})
console.log(empId);
